...
export class Migration20260323133944 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table if not exists "submission" ("id" text not null, "notes" text null, "file_url" text null, "status" text null, "bug_id" text not null, "developer_id" text null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "submission_pkey" primary key ("id"));`);
